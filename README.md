...
[![test coverage](https://img.shields.io/badge/tests-1439%20passing-brightgreen.svg)](https://github.com/johnhenry/isomorphic-jj)
...
### Testing & Quality
- **1439 tests** passing — ~97% statement / 90%+ branch coverage (v1.0–v1.5)
...
**Test Coverage**: 1439 tests, ~97% statements / 90% branches
