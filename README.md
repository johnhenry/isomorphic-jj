...
[![test coverage](https://img.shields.io/badge/tests-1622%20passing-brightgreen.svg)](https://github.com/johnhenry/isomorphic-jj)
...
### Testing & Quality
- **1622 tests** passing — ~97% statement / 91% branch coverage (v1.0–v1.6)
...
**Test Coverage**: 1622 tests, ~97% statements / 91% branches
