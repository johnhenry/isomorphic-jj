...
### v1.0.0 (2025-11-02) - First Stable Release! 🎉

**Production-Ready Features:**
- ✅ 371 tests passing (100% success rate)
- ✅ 95%+ code coverage
- ✅ ~75% revset parity with JJ CLI
- ✅ Semantic versioning commitment
- ✅ Complete documentation suite

**Key Additions in v1.0:**
- Driver failure metadata (`driverFailed`, `driverError` in conflicts)
- Strict mode for merge drivers (`strict: true` option)
- `driver:failed` event emission
- Removed console.warn() calls (use events instead)
- Enhanced revset functions: `none()`, `parents()`, `children()`, `x-`, `x+`
- Timer leak fixes (BackgroundOps, MergeDriverRegistry)

**Breaking Changes:**
- Merge driver errors no longer log to console automatically
  - Migration: Subscribe to `driver:failed` event for error handling

### v0.5.0 - First-Class Conflicts & Enhanced Revsets
- Custom merge drivers (JSON, YAML, Markdown, package.json)
- Dry-run merge preview
- Bulk conflict resolution
- Time-based and graph analytics revset functions

### v0.4.0 - Events & Background Operations
- EventTarget-based event system
- Pre/post-commit hooks
- File watching and auto-snapshots (Node.js)

### v0.3.0 - Git Integration
- Colocated .git and .jj repositories
- JJ CLI compatibility
- Remote operations (fetch/push)
- Shallow clone support

### v0.2.0 - History Editing
- History operations (squash, split, move, abandon, restore)
- Multiple working copies
- Basic revset query language

### v0.1.0 - Core Foundation
- Change-centric model with stable IDs
- Operation log with undo/redo
- No staging area
- Browser support (LightningFS)

**See [CHANGELOG.md](./CHANGELOG.md) for detailed release notes and upgrade guides.**
